pub use tdd_kata::directed_graph_kata::day_6::{DirectedGraph, DirectedCycle};

pub use expectest::prelude::{be_equal_to, be_some, be_ok, be_err, be_true, be_false};
...
describe! directed_graph {
    ...
    describe! graph {
        ...
        it "should create a new empty directed graph" {
            expect!(graph.verticies()).to(be_equal_to(0));
        ...
        it "should add an edge to a graph" {
            ...
            expect!(graph.verticies()).to(be_equal_to(2));
        ...
        it "should add edges to a graph" {
            ...
            expect!(graph.verticies()).to(be_equal_to(4));
    ...
    describe! directed_cycle {
        ...
        it "should create a direct cycle" {
            graph.add_edge(1, 2);
