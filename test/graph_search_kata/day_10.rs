pub use tdd_kata::graph_search_kata::day_10::{UnidirectedGraph, DepthFirstSearch, BreadthFirstSearch};
...
describe! graph_search {
    ...
    describe! dfs {
        ...
        it "should have a path to transient vertex" {
            graph.add_edge(1, 2);
            graph.add_edge(2, 3);
        ...
        it "should not have path to not connected vertex" {
            graph.add_edge(1, 2);
            graph.add_edge(3, 4);
    ...
    describe! bfs {
        ...
        it "should not create a breadth first serach from an empty graph" {
        ...
        it "should not have a path to not connected vertex" {
            graph.add_edge(1, 2);
            graph.add_edge(3, 4);
