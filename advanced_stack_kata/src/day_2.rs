...
mod tests {
    ...
    #[test]
    fn creates_ref_iterator_from_a_stack() {
        let mut stack = Stack::new();
    ...
    #[test]
    fn creates_mut_ref_iterator_from_a_stack() {
        let mut stack = Stack::new();
    ...
    #[test]
    fn creates_iterator_consuming_a_stack() {
        let mut stack = Stack::new();
