...
mod tests {
    ...
    fn add_many(stack: &mut Stack<i32>, size: i32) {
        for e in 1..size + 1 {
            stack.push(e);
        }
    }
    ...
    #[test]
    fn pushes_one_element_on_stack() {
        let mut stack = Stack::new();

        add_many(&mut stack, 1);
    ...
    #[test]
    fn pushes_three_elements_on_stack() {
        let mut stack = Stack::new();

        add_many(&mut stack, 3);
    ...
    #[test]
    fn peeks_head_of_a_stack() {
        let mut stack = Stack::new();

        add_many(&mut stack, 2);
    ...
    #[test]
    fn ref_mut_iterator_over_a_stack() {
        let mut stack = Stack::new();
