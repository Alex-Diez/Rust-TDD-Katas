...
mod tests {
    ...
    fn evaluate_negative_number() {
        assert_eq!(calculate(Cow::Borrowed("-32")), Ok(-32.0));
    }

    #[test]
    fn evaluate_addition() {
        assert_eq!(calculate(Cow::Borrowed("4+12")), Ok(16.0));
    }

    #[test]
    fn evaluate_subtraction() {
        assert_eq!(calculate(Cow::Borrowed("4-11")), Ok(-7.0));
    }
    ...
    fn evaluate_division() {
        assert_eq!(calculate(Cow::Borrowed("42÷6")), Ok(7.0));
    }

    #[test]
    fn evaluate_many_operations() {
        assert_eq!(calculate(Cow::Borrowed("33÷3-2×3+5")), Ok(10.0));
    }

    #[test]
    fn evaluate_operations_with_parenthesis() {
        assert_eq!(calculate(Cow::Borrowed("((3+3)÷3-2)×3+5")), Ok(5.0));
    }
}
