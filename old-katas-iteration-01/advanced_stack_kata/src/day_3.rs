...
impl<'i, T> IntoIterator for &'i mut Stack<T> {
    type Item = &'i mut T;
    type IntoIter = StackMutRefIterator<'i, T>;
...
pub struct StackMutRefIterator<'i, T: 'i> {
    next: Option<&'i mut Node<T>>
}

impl<'i, T> Iterator for StackMutRefIterator<'i, T> {
    type Item = &'i mut T;
...
mod tests {
    ...
    #[test]
    fn pushes_one_element_on_a_stack() {
    ...
    #[test]
    fn iterates_by_ref_over_an_empty_stack() {
    ...
    #[test]
    fn iterates_by_ref_over_a_nonempty_stack() {
        let mut stack = Stack::new();
    ...
    #[test]
    fn iterates_by_mut_ref_over_an_empty_stack() {
        let mut stack: Stack<i32> = Stack::new();
    ...
    #[test]
    fn iterates_by_mut_ref_over_a_nonempty_stack() {
        let mut stack = Stack::new();
    ...
    #[test]
    fn iterates_by_value_over_an_empty_stack() {
        let stack: Stack<i32> = Stack::new();
    ...
    #[test]
    fn iterates_by_value_over_a_nonempty_stack() {
        let mut stack = Stack::new();
